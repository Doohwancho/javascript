...
const BoardList: React.FC = (props: any) => {
  ...
  return (
    <>
      <Row className="mb-3 justify-content-end"> {/* TODO - boostrap으로 grid & button 가져다 썼네?*/}
        <Col xs="auto">
          <Button variant="primary" onClick={() => props.history.push('/board-register')}>등 록</Button> {/* TODO - 뒤로가기 처리 해준다 */}
        </Col>
      </Row>
      {
