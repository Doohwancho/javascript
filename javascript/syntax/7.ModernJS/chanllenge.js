...
var _slicedToArray = function () {
    function sliceIterator(arr, i) {
        ...
        var _e = undefined;
        try {
            for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {  //?1. Symbol ?2. _variables ?3. arr[]()? ?4.done()?
                _arr.push(_s.value); 
                if (i && _arr.length === i) 
                    break; 
            }
    ...
    return function (arr, i) {  
         if (Array.isArray(arr)) {
              return arr; 
        } else if (Symbol.iterator in Object(arr)) { //?5.Symbol.iterator in Object(arr)
...
var _createClass = function () { 
    function defineProperties(target, props) {
        ...
        return function (Constructor, protoProps, staticProps) { //?왜 3개 params? //diff btw protoProps & static Props?
            if (protoProps)
...
var Park = function (_Element) { //new Park('Green Park', 1987, 0.2, 215) ?? _Element?
