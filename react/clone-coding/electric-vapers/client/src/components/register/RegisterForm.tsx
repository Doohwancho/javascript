...
//TODO - form을 styled.form 해서 미리 만들어진걸 가져오고, 거기에 css만 입히는 식으로 하구나!
...
const RegisterForm = () => {
  ...
  const changeAccountHandler = (event: ChangeEvent<HTMLInputElement>) => {//TODO - form에 changeEvent할 떄마다 값을 받아서 setACcount에 넣어주는구나 
